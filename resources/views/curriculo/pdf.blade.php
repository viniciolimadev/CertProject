                            ...
                            <div>
                                ...
                                @php
                                    ...
                                    if (!empty($profile->social_links)) {
                                        ...
                                        } else if (is_string($profile->social_links)) {
                                            $links = array_filter(array_map('trim', explode(',', $profile->social_links)));
                                        }
                                    }
                                @endphp
                                @foreach($links as $link)
                                    <a href="{{ $link }}" target="_blank" class="text-blue-600 hover:text-blue-800 hover:underline">{{ $link }}</a>@if(!$loop->last), @endif
                                @endforeach
                                </span>
                            </div>
                        @endif
