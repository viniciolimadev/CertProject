...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\laragon\www\Certproject\Certproject\public\storage' => 'string',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\laragon\\www\\Certproject\\Certproject\\public\\storage',
...
'hashing.rehash_on_login','view.paths','view.compiled','dompdf.show_warnings','dompdf.public_path',
...
'sanctum.csrf-cookie','home','certificates.view','certificates.index',
'certificates.create','certificates.store','projects.index','projects.create','projects.store',
'users.show','projects.show','projects.edit','projects.update','projects.destroy',
'certificates.show','certificates.edit','certificates.update','certificates.destroy','experiences.index',
'experiences.create','experiences.store','experiences.show','experiences.edit','experiences.update',
'experiences.destroy','educations.index','educations.create','educations.store','educations.destroy',
'curriculo.index','personal_info.edit','personal_info.update','curriculo.export','users.public-projects',
'projects.explore','storage.local',);
        registerArgumentsSet('views', 
'auth.confirm-password','auth.forgot-password','auth.layout','auth.login','auth.passwords.confirm',
'auth.passwords.email','auth.passwords.reset','auth.register','auth.reset-password','auth.verify',
'auth.verify-email','certificates.create','certificates.index','components.application-logo','components.auth-session-status',
...
'components.text-input','curriculo.index','curriculo.pdf','dashboard','educations.create',
'educations.index','experiences.create','experiences.index','home','layout',
'layouts.app','layouts.guest','layouts.navigation','personal_info.edit','profile.edit',
'profile.partials.delete-user-form','profile.partials.update-password-form','profile.partials.update-profile-information-form','projects.create','projects.index',
...
'APP_LOCALE','APP_FALLBACK_LOCALE','APP_FAKER_LOCALE','APP_DEBUG','APP_ENV',
...
'QUEUE_CONNECTION','CACHE_DRIVER','MEMCACHED_HOST','REDIS_CLIENT','REDIS_HOST',
