...
return [
    ...
    // Inclui o ponto de entrada principal (se necessário, geralmente não para estático)
    // 'public/index.php' => 'index.php',

    // Inclui arquivos padrão
    'public/robots.txt' => 'robots.txt',
    'public/favicon.ico' => 'favicon.ico', // Adicione se você tiver um

    // Adicione aqui quaisquer outros diretórios/arquivos públicos
    // que você precise (ex: 'public/images' => 'images'),
    // mas **NÃO** inclua 'public/storage' ou a linha 'public' => ''.
],
